...
public class PaperTitleReportController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/approvedPaperTitleReport.html", method = RequestMethod.POST)
	public void approvedPaperTitleReport(HttpSession httpSession, Integer paperTitleReportId, ModelMap modelMap,HttpServletResponse response) {
		PaperTitleReport paperTitleReport = paperTitleReportService.findById(paperTitleReportId);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/notApprovedPaperTitleReport.html", method = RequestMethod.POST)
	public void notApprovedPaperTitleReport(HttpSession httpSession, Integer paperTitleReportId, ModelMap modelMap,HttpServletResponse response) {
		PaperTitleReport paperTitleReport = paperTitleReportService.findById(paperTitleReportId);
